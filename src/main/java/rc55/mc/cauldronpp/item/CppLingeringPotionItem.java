...
public class CppLingeringPotionItem extends LingeringPotionItem {
    ...
    public void appendStacks(ItemGroup group, DefaultedList<ItemStack> stacks) {
        if (this.isIn(group)) {
            stacks.add(PotionHelper.getPotionItem(PotionHelper.LINGERING_TYPE, 32767));
            stacks.add(PotionHelper.getPotionItem(PotionHelper.LINGERING_TYPE, 16123));
            stacks.add(PotionHelper.getPotionItem(PotionHelper.LINGERING_TYPE, 81621));
            stacks.add(PotionHelper.getPotionItem(PotionHelper.LINGERING_TYPE, 55577));
        }
    }
}
