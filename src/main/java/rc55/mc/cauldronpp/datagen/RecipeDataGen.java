...
public class RecipeDataGen extends FabricRecipeProvider {
    ...
    public void generateRecipes(Consumer<RecipeJsonProvider> consumer) {
        ShapelessRecipeJsonBuilder.create(CauldronppBlocks.CPP_CAULDRON).input(Items.CAULDRON).input(Blocks.BREWING_STAND).group("cppcauldron")
        ...
        ShapedRecipeJsonBuilder.create(CauldronppBlocks.CPP_CAULDRON).input('a', Items.IRON_INGOT).input('b', Blocks.BREWING_STAND)
