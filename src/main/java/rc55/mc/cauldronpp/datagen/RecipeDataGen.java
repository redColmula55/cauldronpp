...
public class RecipeDataGen extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, CauldronppBlocks.CPP_CAULDRON).input(Items.CAULDRON).input(Blocks.BREWING_STAND).group("cppcauldron")
                .criterion(hasItem(Blocks.BREWING_STAND), conditionsFromItem(Blocks.BREWING_STAND)).offerTo(recipeExporter, Identifier.of(Cauldronpp.MODID, "cppcauldron"));
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, CauldronppBlocks.CPP_CAULDRON).input('a', Items.IRON_INGOT).input('b', Blocks.BREWING_STAND)
                ...
                .criterion(hasItem(Blocks.BREWING_STAND), conditionsFromItem(Blocks.BREWING_STAND)).offerTo(recipeExporter, Identifier.of(Cauldronpp.MODID, "cppcauldron2"));
    }
}
